export const BELIEFS_PARAGRAPHS = [
  "Creemos en un Dios único, eterno y creador de todas las cosas, quien se ha dado a conocer al ser humano y desea tener una relación cercana con cada persona.",
  "Creemos que Dios se manifestó en Jesucristo, quien vino al mundo para mostrarnos su amor y ofrecernos salvación. Él es el centro de nuestra fe y quien nos guía en nuestro caminar espiritual.",
